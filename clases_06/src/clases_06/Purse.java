...
public class Purse { // Este objeto representa un monedero virtual
	private int pennies;
	private int nickels;
	private int dimes;
	...
	public String toString() {
		return new String(quarters + " quarters + " + dimes + " dimes + " + nickels + " nickels + " + pennies
				+ " pennies = $" + dollars());
	}

	public static void main(String[] args) {
		Purse purse = new Purse(); // Invoca el constructor por defecto
